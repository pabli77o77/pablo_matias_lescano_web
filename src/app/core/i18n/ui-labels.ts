export const UI_LABELS = {
  es: {
    ...
    jsonDesc: 'Ingeniería de Extremo a Extremo: Desde la gestión de estado reactivo y calidad de código (QA), hasta la optimización de infraestructuras críticas de Big Data (+6.8M registros).',
    current: 'Actual',
    at: 'en',
    kpiExp: 'Años de Exp.',
  ...
  en: {
    ...
    jsonDesc: 'End-to-End Engineering: From reactive state management and code quality (QA), to critical Big Data infrastructure optimization (+6.8M records).',
    current: 'Current',
    at: 'at',
    kpiExp: 'Years of Exp.',
